...
png ('./figures/F_NL_mortality_19012021.png', width=1280*s, height=905.5*s, res=96)
...
rect (xleft = seq(0.59, 0.59+52, 1), xright = seq(1.05, 1.05+52, 1), ybottom = rep(0, 53), ytop = (predict.m4d), col=new.blue, border='white')
rect (xleft = seq(0.95, 0.95+52, 1), xright = seq(1.41, 1.41+52, 1), ybottom = rep(0, 53), ytop = (d.2020$deaths), col=new.red, border='white')

rect (xleft = seq(0.95, 0.95+52, 1), xright = seq(1.41, 1.41+52, 1), ybottom = d.2020$deaths - d.2020$covid, ytop = (d.2020$deaths), col=new.reddark, border='white')
